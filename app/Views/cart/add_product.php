...
<html lang="en">
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
      <div class="wrapper">
         ...
         <nav class="main-header navbar navbar-expand navbar-white navbar-light bg-primary">
            ...
            <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item dropdown">
                  ...
                  <img src="<?=base_url("public/assets/img/user2-160x160.jpg");?>" class="img-circle" style="width: 40px;">  Admin
                  </a>
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item menu-open">
                        ...
                        <ul class="nav">
                           <li class="nav-item">
                              <a href="<?= base_url("item_list");?>" class="nav-link">
         ...
         <div class="content-wrapper">
            ...
            <div class="new-button">
               ...
               <button type="button" class="btn btn-primary"><i style="font-size:18px" class="fa">&#xf002;</i><a href="<?=base_url("search");?>">Search</a></button>
               <button type="button" class="btn btn-warning">Reset</button>
            </div>
            <div class="col-md-12 mt-5">
               <div class="card">
                  <div class="card-header">
                     <h3 class="card-title">Enter Product Informations</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                  <?= session()->getFlashdata('error') ?>
                  <?= validation_list_errors() ?>
                     <form action="<?= base_url('/cart/add_product')?>" method="POST">
                     <?= csrf_field() ?>
                     <div class="form-group">
                        <label class="form-label">Product name</label>
                        <input class="form-control" name="product_name" placeholder="Item name" value="<?= set_value('product_name') ?>">
                     </div>
                     <div class="form-group">
                        <label class="form-label">MRP</label>
                        <input class="form-control" name="mrp" placeholder="MRP" value="<?= set_value('mrp') ?>">
                     </div>
                     <div class="form-group">
                        <label class="form-label">Discount</label>
                        <input class="form-control" name="discount" placeholder="Discount" value="<?= set_value('discount') ?>">
                     </div>
                     <div class="form-group">
                        <label class="form-label">Quantity</label>
                        <input class="form-control" name="quantity" placeholder="Quantity" value="<?= set_value('quantity') ?>">
                     </div>                  
                     <div class="save mb-2">
                        <button type="submit" class="btn btn-primary"><i style="font-size:24px" class="fa">&#xf0c7;</i> Save</button></a>
      ...
      <!-- jQuery UI 1.11.4 -->
      <script src="<?= base_url("public/assets/plugins/jquery-ui.min.js");?>"></script>
