      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <div class="new-button">
               <button type="button" class="btn btn-danger"><i class='fas'>&#xf044;</i><a href="<?=base_url("add_product");?>">New</a></button>
            </div>
                        ...
                        <div class="card-body">
                           ...
                           <?php foreach ($results as $val): ?>
                              <tr>
                                 ...
                                 <td> 
                                    <a href="edit" role="button" class="btn btn-primary btn-sm" ><i class="fas fa-edit"></i></a>
                                    <a href="delete" role="button" onClick="return confirm('Do you want to delete this news?')" class="btn btn-sm btn-danger" ><i class="fas fa-trash-alt"></i></a>
                                 </td>
                              </tr>
