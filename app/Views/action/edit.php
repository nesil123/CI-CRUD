      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <div class="new-button">
               ...
               <button type="button" class="btn btn-primary"><i style="font-size:18px" class="fa">&#xf002;</i>Search</button>
            ...
            <div class="col-md-12 mt-5">
               <div class="card">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                     <form action="<?= base_url('action/update/' . $id)?>" method="POST">
                     <?= csrf_field() ?>
                     <div class="form-group">
                        <label class="form-label">Product name</label>
                        <input class="form-control" name="product_name" placeholder="Item name" value="<?= ($product_name!="") ? $product_name : "" ?>">
                     </div>
                     <div class="form-group">
                        <label class="form-label">MRP</label>
                        <input class="form-control" name="mrp" placeholder="MRP" value="<?= ($mrp!="") ? $mrp : "" ?>">
                     </div>
                     <div class="form-group">
                        <label class="form-label">Discount</label>
                        <input class="form-control" name="discount" placeholder="Discount" value="<?= ($discount!="") ? $discount : "" ?>">
                     </div>
                     <div class="form-group">
                        <label class="form-label">Quantity</label>
                        <input class="form-control" name="quantity" placeholder="Quantity" value="<?= ($quantity!="") ? $quantity : "" ?>">
                     </div>                  
                     <div class="save mb-2">
                        <button type="submit" class="btn btn-primary"><i style="font-size:24px" class="fa">&#xf0c7;</i> Update</button></a>
