         ...
         <nav class="main-header navbar navbar-expand navbar-white navbar-light bg-primary">
            ...
            <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item dropdown">
                  <a class="nav-link" data-toggle="dropdown" href="<?= base_url("/");?>" style="color: white;">
            ...
            <div class="container-fluid mt-5">
               <div class="row">
                  <div class="col-md-12">
                     ...
                     $un = '';
                     ?>
                     <div class="col-md-8 offset-md-2" style="padding-top:10px;display:<?=$srdiv?>" name="srdiv"  id="srdiv">
                    <form method="get" action="<?php echo base_url('item_list');?>" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" value="<?=$un?>" name="un" id="un" placeholder="Type your keywords here"/>
                           ...
                           <table class="table table-bordered">
                            ...
                            <?php foreach ($results as $val): ?>
                              <tr>
                                 ...
                                 <td> 
                                    <a href="<?= base_url('action/edit/'.$val->id)?>" role="button" class="btn btn-primary btn-sm" ><i class="fas fa-edit"></i></a>
                                    <a href="<?= base_url('action/delete/'.$val->id)?>" role="button" onClick="return confirm('Do you want to delete this item?')" class="btn btn-sm btn-danger" ><i class="fas fa-trash-alt"></i></a>
                                 </td>
                              </tr>
